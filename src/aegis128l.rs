...
//!
//! Provides authenticated encryption and decryption using the AEGIS-128L construction.
//!
//! ## Example
//! ```rust
//! use aes_wasm::aegis128l::{encrypt, decrypt, Key, Nonce};
//! let key = Key::default();
...
/// Key type for AEGIS-128L (16 bytes).
pub type Key = [u8; KEY_LEN];
/// Tag type for AEGIS-128L (32 bytes).
pub type Tag = [u8; TAG_LEN];
/// Nonce type for AEGIS-128L (16 bytes).
...
/// # Example
/// ```
/// use aes_wasm::aegis128l::{encrypt_detached, Key, Nonce};
/// let key = Key::default();
/// let nonce = Nonce::default();
/// let msg = b"hello";
/// let ad = b"ad";
...
/// # Example
/// ```
/// use aes_wasm::aegis128l::{encrypt, Key, Nonce};
/// let key = Key::default();
/// let nonce = Nonce::default();
/// let msg = b"hello";
/// let ad = b"ad";
...
/// # Example
/// ```
/// use aes_wasm::aegis128l::{encrypt_detached, decrypt_detached, Key, Nonce};
/// let key = Key::default();
/// let nonce = Nonce::default();
/// let msg = b"hello";
/// let ad = b"ad";

...
//!
//! Provides authenticated encryption and decryption using AES-128 in GCM mode.
//!
//! ## Example
//! ```rust
...
/// Key type for AES-128-GCM (16 bytes).
pub type Key = [u8; KEY_LEN];
/// Tag type for AES-128-GCM (16 bytes).
pub type Tag = [u8; TAG_LEN];
/// Nonce type for AES-128-GCM (12 bytes).
...
/// # Example
/// ```
/// use aes_wasm::aes128gcm::{encrypt_detached, Key, Nonce};
/// let key = Key::default();
/// let nonce = Nonce::default();
/// let msg = b"hello";
/// let ad = b"ad";
...
/// # Example
/// ```
/// use aes_wasm::aes128gcm::{encrypt, Key, Nonce};
/// let key = Key::default();
/// let nonce = Nonce::default();
/// let msg = b"hello";
/// let ad = b"ad";
...
/// # Example
/// ```
/// use aes_wasm::aes128gcm::{encrypt_detached, decrypt_detached, Key, Nonce};
/// let key = Key::default();
/// let nonce = Nonce::default();
/// let msg = b"hello";
/// let ad = b"ad";

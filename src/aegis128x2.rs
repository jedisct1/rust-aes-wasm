...
/// Key type for AEGIS-128X2 (16 bytes).
pub type Key = [u8; KEY_LEN];
/// Tag type for AEGIS-128X2 (32 bytes).
pub type Tag = [u8; TAG_LEN];
/// Nonce type for AEGIS-128X2 (16 bytes).
...
/// # Example
/// ```
/// use aes_wasm::aegis128x2::{encrypt_detached, Key, Nonce};
/// let key = Key::default();
/// let nonce = Nonce::default();
/// let msg = b"hello";
/// let ad = b"ad";
...
/// # Example
/// ```
/// use aes_wasm::aegis128x2::{encrypt, Key, Nonce};
/// let key = Key::default();
/// let nonce = Nonce::default();
/// let msg = b"hello";
/// let ad = b"ad";
...
/// # Example
/// ```
/// use aes_wasm::aegis128x2::{encrypt_detached, decrypt_detached, Key, Nonce};
/// let key = Key::default();
/// let nonce = Nonce::default();
/// let msg = b"hello";
/// let ad = b"ad";
...
pub fn decrypt_detached(
    ...
    unsafe {
        let res = zig::_aegis128x2_decrypt(
            msg.as_mut_ptr(),
            msg_len,
            ciphertext.as_ptr(),
            ciphertext.len(),

...
/// Key type for AES-256-OCB (32 bytes).
pub type Key = [u8; KEY_LEN];
/// Tag type for AES-256-OCB (16 bytes).
pub type Tag = [u8; TAG_LEN];
/// Nonce type for AES-256-OCB (12 bytes).
...
/// # Example
/// ```
/// use aes_wasm::aes256ocb::{encrypt_detached, Key, Nonce};
/// let key = Key::default();
/// let nonce = Nonce::default();
/// let msg = b"hello";
/// let ad = b"ad";
...
/// # Example
/// ```
/// use aes_wasm::aes256ocb::{encrypt, Key, Nonce};
/// let key = Key::default();
/// let nonce = Nonce::default();
/// let msg = b"hello";
/// let ad = b"ad";
...
/// # Example
/// ```
/// use aes_wasm::aes256ocb::{encrypt_detached, decrypt_detached, Key, Nonce};
/// let key = Key::default();
/// let nonce = Nonce::default();
/// let msg = b"hello";
/// let ad = b"ad";
